...
const en: Translations = {
  ...
  roleSelect: {
    ...
    contractorDesc: 'Create your verified profile and get discovered by manufacturers looking for workforce partners. Sign up, complete your profile, and our team will review and verify it.',
  ...
  auth: {
    ...
    contractorRoleDesc: 'Create a verified profile and get discovered by manufacturers',
...
const hi: Translations = {
  ...
  auth: {
    ...
    contractorRoleDesc: 'सत्यापित प्रोफ़ाइल बनाएं और निर्माताओं द्वारा खोजे जाएं',
...
const mr: Translations = {
  ...
  auth: {
    ...
    contractorRoleTitle: 'ठेकेदार',
    contractorRoleDesc: 'सत्यापित प्रोफाइल तयार करा आणि उत्पादकांद्वारे शोधले जा',
    businessRoleTitle: 'व्यवसाय',
